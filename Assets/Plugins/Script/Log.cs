...
public class DebugSetting {
    ...
    public static bool isOpenTTConsole = false;
    public static bool isOpenDebugConsole = false;
    #endregion
            ...
            if (!isLoadConfig) {
                ...
                while (xr.Read()) {
                    if (xr.NodeType == XmlNodeType.Element) {
                        if (xr.Name == "game") {
                            enableLog = bool.Parse(xr.GetAttribute("debug"));
                            break;
                        }
                    }
                }
                ...
                Application.logMessageReceived += HandlerUnityLog;
            }
    ...
    static void HandlerUnityLog(string condition, string stackTrace, LogType type) {
